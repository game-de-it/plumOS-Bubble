...
grep -Fq 'export LD_PRELOAD="$PLUMOS_ROOT/emulator/lib/libmali.so.1"' "$standalone"
...
printf 'bubble_hardware_rendering_policy=result-ok pyxel=mali-required portmaster_gui=mali-required ppsspp=canonical-mali ports=hardware-preferred\n'
