...
power_finalization=frontend-request,pid1-storage-read-only,forced-kernel-action
app_layer_verification=full-at-build-update-deploy,boot-critical-metadata-only
frontend_stages=S34_RECOVERY_NETWORK_BACKGROUND_DISPATCHED,S38_RECOVERY_NETWORK_BACKGROUND_FINISHED,S39_APP_LAYER_METADATA_READY,S40-S41,S90-S91,E39,E40,E80-E81,E90-E92
